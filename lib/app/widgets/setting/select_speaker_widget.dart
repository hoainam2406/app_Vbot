...
class SelectSpeakerWidget extends StatefulWidget {
  const SelectSpeakerWidget({super.key});

  @override
  State<SelectSpeakerWidget> createState() => _SelectSpeakerWidgetState();
}

const List<String> items = <String>[
  'Speaker (Realtek(R) Audio)',
  'Apeaker 2 (Realtek(R) Audio)',
];

class _SelectSpeakerWidgetState extends State<SelectSpeakerWidget> {
