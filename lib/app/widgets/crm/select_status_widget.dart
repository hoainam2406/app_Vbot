...
class SelectStatusWidget extends StatefulWidget {
  ...
  @override
  State<SelectStatusWidget> createState() => _SelectTypeCallWidget2State();
}
...
const List<String> items = <String>[
  ...
  'OK2',
  'Tiềm năng',
  'Một chiếc playlist tổng hợp top 21 bài hát không thể bỏ qua tại The Masked Singer | TOP HIT',
];

class _SelectTypeCallWidget2State extends State<SelectStatusWidget> {
