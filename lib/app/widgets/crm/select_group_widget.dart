...
class SelectGroupWidget extends StatefulWidget {
  ...
  @override
  State<SelectGroupWidget> createState() => _SelectTypeCallWidget2State();
}
...
const List<String> items = <String>[
  ...
  'Nhóm quản lý khách hàng dài vượt quá vùng chứa',
];

class _SelectTypeCallWidget2State extends State<SelectGroupWidget> {
