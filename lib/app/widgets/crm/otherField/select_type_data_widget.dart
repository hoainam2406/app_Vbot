...
class SelectTypeDataWidget extends StatefulWidget {
  const SelectTypeDataWidget({super.key});

  @override
  State<SelectTypeDataWidget> createState() => _SelectTypeCallWidget2State();
}
...
class _SelectTypeCallWidget2State extends State<SelectTypeDataWidget> {
