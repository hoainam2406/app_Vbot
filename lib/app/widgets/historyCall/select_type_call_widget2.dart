...
class SelectTypeCallWidget2 extends StatefulWidget {
  const SelectTypeCallWidget2({super.key});

  @override
  State<SelectTypeCallWidget2> createState() => _SelectTypeCallWidget2State();
}
...
class _SelectTypeCallWidget2State extends State<SelectTypeCallWidget2> {
